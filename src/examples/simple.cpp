...
class SampleModule : public Module
{
	public:
		...
		SampleModule() : Module("/sample")
		{
			...
			Get["/ok"] = [](auto) { return Http::Forbidden; };
...
// class SimpleModule : public NivenModule
// {
// 	public:
// 		SimpleModule()
// 		{
// 			Get["/"] = [](auto &c) { return "The moon's a balloon"; };
// 		}
// };
...
int main(int argc, char **argv)
{
	...
	// host.Resolve<Redis>()->Initialise(true, "/tmp/redis.sock");
